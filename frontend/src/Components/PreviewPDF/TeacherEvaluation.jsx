  ...
  return (
    <div className=" mx-auto px-4 pb-4 bg-white ">
      ...
      <table className="w-full text-black font-bold border-collapse border ">
        ...
        <tbody>
          <tr>
            <th className="border  px-2 py-1 text-left" colSpan={2}></th>
            <th className="border 300 px-2 py-1 text-left">
              Needs Improvement
            </th>
            <th className="border  px-2 py-1 text-left">Developing</th>
            <th className="border  px-2 py-1 text-left">Sufficient</th>
            <th className="border  px-2 py-1 text-left">Above Average</th>
            <th className="border  px-2 py-1 text-left">Total Mark</th>
          </tr>
        </tbody>
        <tbody>
          <tr>
          ...
          <tr>
            <td className="border  px-2 py-1">Content Quality</td>
            <td className="border  px-2 py-1">
          ...
          <tr>
            <td className="border  px-2 py-1">Spelling & Grammar</td>
            <td className="border  px-2 py-1">
              {data.courseType === "theory" ? "1" : "2"}
            </td>
            <td className="border  px-2 py-1"></td>
          ...
          <tr>
            <td className="border  px-2 py-1">Organization and Formatting</td>
            <td className="border  px-2 py-1">
              {data.courseType === "theory" ? "1" : "2"}
            </td>{" "}
            <td className="border  px-2 py-1"></td>
