...
function InputForm({ inputData, setInputData, templateName }) {
  const pathname = usePathname() || "";
  const url = pathname || (templateName ? `/template/${templateName}` : "");
  ...
  return (
    <form className="flex flex-col items-center text-sm text-slate-800">
      ...
      <div className="max-w-96 w-full px-4 space-y-4">
        ...
        {/* Teacher Info */}
        <TeacherInfo inputData={inputData} handleChange={handleChange} templateName={templateName} />
